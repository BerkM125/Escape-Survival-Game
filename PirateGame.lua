...
bodyPosition = Boat.Position
bodyVelocity = Boat.BodyVelocity 
wait(20)
while true do
	
	path = game:GetService("PathfindingService"):ComputeRawPathAsync(game.Workspace.Boat.Points.StartBoat.Position, game.Workspace.Boat.Points.FinishBoat.Position, 500)
	points = path:GetPointCoordinates()
	
	game.Workspace.Boat.Points:ClearAllChildren()
	...
	for p = 1, #points do
		...
		part.Parent = game.Workspace.Boat.Points
		part.Transparency = 1
		game.Workspace.Boat.Anchored = false
		Boat.Position = part.Position
		game.Workspace.Boat.Anchored = true
		print(Boat.BodyPosition.Position)
		wait(0.1)
	end
	wait(0.1)
